...
function manage_group(msg)
	...
	elseif msg.text:lower() == "/about" or msg.text:lower() == "about" then
		about_txt = "*Jil Robot* v"..bot_version.."\n`رباتی منحصر به فرد و رایگان برای مدیران کانال ها و گروه ها همچنین افرادی که میخواهند خاص و متفاوت باشند.\nامکانات ربات:`\n"..ghabeliyat
			.."\n\n`طراحی و ساخت توسط خودم...`"
		about_key = {{{text = "کانال فاز شبانه" , url = "https://telegram.me/faze_shabane"},{text = "پشتیبان ربات" , url = "https://telegram.me/Amir_B_80_bot"}},{{text = "سازنده ربات" , url = "https://telegram.me/faze_shabane"},{text = "سفارش ربات" , url = "https://telegram.me/Amir_B_80_bot"}}}
...
function run(msg)
   ...
   - و...]]
	...
	add_key = {{{text = "افزودن ربات به گروه" , url = "https://telegram.me/antilink_amir2030bot?startgroup=start"}}}
	...
	elseif msg.text == "ارتباط با ما" or msg.text == "درباره ما" or msg.text:lower() == "about" or msg.text:lower() == "/about" then
		...
		about_key = {{{text = "کانال فاز شبانه" , url = "https://telegram.me/faze_shabane"}},{{text = "ادمین و پشتیبان ربات" , url = "https://telegram.me/khajeh_amir"}},{{text = "کانال سازنده ربات" , url = "https://telegram.me/faze_shabane"}},{{text = "سفارش ربات" , url = "https://telegram.me/Amir_B_80_bot"}}}
	...
	elseif msg.text == "تبلیغ و تبادل" then
		...
		return send_inline(msg.from.id, text, {{{text = "ارتباط با ادمین تبلیغات" , url = "https://telegram.me/khajeh_amir"}},{{text = "نرخ و شرایط تبلیغات" , url = "https://telegram.me/khajeh_amir"}}})
	...
	elseif msg.text == "مثال کیبرد اینلاین" then
		return send_inline(msg.from.id, "`تیتر کیبرد اینلاین با قابلیت استفاده از قابلیت مارک داون و هایپر لینک.`", {{text = "کانال فازشبانه" , url = "https://telegram.me/faze_shabane"}},{{{text = "ایمیل سازنده" , url = "amir.khajeh7@gmail.com"}}})
	end
	...
	elseif users[userid].action == 22 then
		...
		if users[userid].tab == 1 then
			...
			users[userid].action = 0
			save_data("users.json", users)
			send_msg(msg.from.id, "`@Bot "..hashid.."`", true)
